...
describe("SALES VALIDATION TESTS", () => {
    ...
    describe("ValidateSalesDni", () => {
        ...
        it('ST3 - DNI con más de 8 dígitos', () => {
        ...
        it('ST4 - DNI con caracteres no numéricos', () => {
