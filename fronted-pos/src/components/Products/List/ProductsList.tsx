...
import { TableRowBodyType } from "@/components/common/TableRowBody";
...
export const ProductsList = () => {
  ...
  const updateProduct: TableRowBodyType<Product>["updateProduct"] = (
    id,
    updatedProps
  ) => {
            ...
            <CardContent>
              <div className="grid gap-6 ">
                ...
                <div className="relative grid items-center">
                  ...
                  <Button
                    className={cn(
                      "absolute inset-[auto_0.25em_auto_auto] h-5/6 z-30",
                      {
