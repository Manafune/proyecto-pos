...
import { SignUpSchemaValidator } from '@/lib/validation/validation';

interface UserFormProps {
	onSubmit: () => void;
	register: UseFormRegister<SignUpSchemaValidator>;
	control: Control<SignUpSchemaValidator>;
	errors: FieldErrors<SignUpSchemaValidator>;
}

const UserForm: React.FC<UserFormProps> = ({ onSubmit, register, errors }) => {
	return (
